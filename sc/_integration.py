...
def harmony(
	...
	*,
	...
	sc.external.pp.harmony_integrate(_adata,key=batch_key,max_iter_harmony=max_iter_harmony)
	sc.pp.neighbors(_adata,n_neighbors=n_neighbors,use_rep= 'X_pca_harmony')
	sc.tl.umap(_adata)
	...
	sc.pl.embedding(_adata,color=batch_key,basis ='X_pca_harmony',legend_loc=legend_loc,legend_fontsize=legend_fontsize,show=False)
